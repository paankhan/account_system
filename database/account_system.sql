...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 07, 2022 at 10:36 AM
...
--
CREATE DATABASE IF NOT EXISTS `account_system` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `account_system`;
...
('root', '[{\"db\":\"account_system\",\"table\":\"transaction\"},{\"db\":\"account_system\",\"table\":\"account_detail\"}]');
...
('root', '2022-03-07 09:34:12', '{\"Console\\/Mode\":\"collapse\"}');
